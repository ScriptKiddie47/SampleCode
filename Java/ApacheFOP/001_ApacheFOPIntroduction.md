...
1. Java Source
    ...
    public class ApacheFOPJavaExample {
        public void generatePDF() throws IOException {
            try (OutputStream out = new BufferedOutputStream(
                    new FileOutputStream(new File("src/main/resources/myfile.pdf")))) {
...
1. As part of the output we get a PDF generated with `Hello, Frank!` as text.