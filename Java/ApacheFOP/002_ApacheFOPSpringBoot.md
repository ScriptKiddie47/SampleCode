...
1. Offical Docs are top notch : https://xmlgraphics.apache.org/
...
1. Dependency
    ...
    ```
1. Create a `fop.xconf` file. Below is the default config file
...
1. Create `name-pdf-stylesheet.xsl` file
...
1. Service Sourecode 
    ...
    ```java
    package com.scripter.carorder.service;
...
1. Controller
    ...
    ```java
    package com.scripter.carorder.controller;
    ...
    import com.scripter.carorder.service.CarOrderService;
    ...
    public class CarOrderController {
        ...
        public ResponseEntity<InputStreamResource> getOrderReportPDF() {
            byte[] bytes = carOrderService.orderReportPDF();
